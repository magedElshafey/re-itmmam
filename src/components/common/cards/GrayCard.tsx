...
const GrayCard: React.FC<GrayCardProps> = ({ index, data }) => {
  return (
    <div className="bg-[#e5e6eb] w-full p-7 flex flex-col items-center justify-center rounded-lg relative">
      ...
      <p className="text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-4xl font-bold z-30 text-mainColor">
        {data?.title} :
      </p>
